  ...
  return (
    <section className="w-full pt-2 pb-6">
      ...
      <div className="text-base sm:text-lg leading-relaxed text-justify space-y-4 mb-8 font-im-fell text-ink">
        ...
        <p>
          Para conseguirmos fazer tudo com excelência, confirme sua presença no campo abaixo. A cerimônia e a recepção serão em Lagoa Santa. Horários e endereços exatos serão informados no convite entregue em mãos.
        </p>
        <p>
